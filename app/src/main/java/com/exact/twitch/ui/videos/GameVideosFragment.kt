...
class GameVideosFragment : BaseVideosFragment(), VideosSortDialog.OnFilterApplied {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sortByRl.setOnClickListener { VideosSortDialog.newInstance(prefs.getInt(SORT_TAG, DEFAULT_SORT_ID), prefs.getInt(PERIOD_TAG, DEFAULT_PERIOD_ID)).show(childFragmentManager, null) }
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (isFragmentVisible) {
            ...
            val observer = Observer<CharSequence> { sortText.text = getString(R.string.sort_and_period, viewModel.sortText.value, viewModel.periodText.value) }
